 || 2026-06-06 | feat | OB Engine: file logging (ob_signals.log, 5MB rotation, 3 backups) + logger.debug на каждый отказ сигнала. | Hermes
    ...
    11|    10|     9|     8|     7|  — status property: расширен recent_signals (последние 20 записей)
    12|    11|    10|     9|     8|  — Python import check: ✅ все 5 файлов
    13|    12|    11|    10|     9|    1| || 2026-06-06 | feat | OB Wizard: «?» подсказки во всех 7 шагах + «Стандартные» кнопка с пресетами под каждую стратегию. OB Run Detail: «?» подсказки в настройках. build v85 | Hermes
