...
HARDCODED_STRATEGIES = [
    ...
    # ═══════════════════════════════════════════════════
    # Ступенчатые паттерны
    # ═══════════════════════════════════════════════════
    StrategyInfo(
        name="stair_climber",
        description="🪜 Лесенка — поиск ступенчатого роста/падения цены (higher highs/lows) с нарастающим объёмом. Вход на откате к EMA(9). Работает на 1m-3m.",
        type="indicator_based",
        nuances=(
            "🪜 **Ступенчатый паттерн**\n\n"
            "📈 **Как работает:**\n"
            "• Находит 3-5 свечей с повышающимися high/low (лесенка вверх)\n"
            "• Или понижающимися high/low (лесенка вниз)\n"
            "• Объём каждой ступеньки растёт ≥×1.2\n"
            "• Рассчитывает наклон (slope) = изменение цены / N свечей / ATR\n\n"
            "📥 **Вход:**\n"
            "• После формирования лесенки — вход на откате к EMA(9)\n"
            "• Сигнал только если slope ≥ 3.0 (сильный тренд)\n\n"
            "📤 **Выход:**\n"
            "• TP: уровень следующей ступеньки (последний high/low лесенки)\n"
            "• SL: уровень предыдущей ступеньки (первый low/high лесенки)\n\n"
            "⚙️ **Параметры:** min_steps=3, slope_threshold=3.0, "
            "volume_growth=1.2, pullback_ema=9\n"
            "\n"
            "📊 **Рекомендуемый TF:** 1m–3m"
        ),
    ),
]
