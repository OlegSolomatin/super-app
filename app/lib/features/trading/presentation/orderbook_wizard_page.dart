...
const _kObStrategies = [
  ...
  _ObStrategyOption(
    ...
    description: 'Обнаруживает скрытые ордера (iceberg) — торгует в сторону крупного игрока',
    params: [
      _ObStrategyParam(
        key: 'iceberg_ratio',
        label: 'Iceberg ratio',
        unit: 'x',
        defaultValue: 3.0, min: 1.5, max: 10.0, divisions: 17,
      ),
      _ObStrategyParam(
        key: 'min_volume_btc',
        label: 'Мин. объём',
        unit: ' BTC',
        defaultValue: 0.5, min: 0.1, max: 5.0, divisions: 49,
      ),
    ],
  ),
];
